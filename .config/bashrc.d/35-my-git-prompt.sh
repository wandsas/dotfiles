...
# If git-prompt.sh not available ==> We try to get it from upsteam git.
if [ -r $XDG_CONFIG_HOME/bashrc.d/git-prompt.sh ]; then
  curl -sLOf $XDG_CONFIG_HOME/bashrc.d/git-prompt.sh --create-dirs \
